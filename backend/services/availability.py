...
class AvailabilityAgent:
    ...
    PLATFORMS = [
        {"id": "netflix", "name": "Netflix", "color": "#E50914", "icon": "netflix_icon.png"},
        {"id": "prime", "name": "Amazon Prime Video", "color": "#00A8E1", "icon": "prime_icon.png"},
        {"id": "max", "name": "Max", "color": "#002BE7", "icon": "max_icon.png"},
        {"id": "disney", "name": "Disney+", "color": "#113CCF", "icon": "disney_icon.png"},
        {"id": "hulu", "name": "Hulu", "color": "#1CE783", "icon": "hulu_icon.png"},
        {"id": "apple", "name": "Apple TV+", "color": "#000000", "icon": "apple_icon.png"}
    ]
    ...
    def _deterministic_random_price(self, movie_title: str) -> float:
        hash_val = int(hashlib.md5((movie_title + "_price").encode('utf-8')).hexdigest(), 16)
    ...
    async def get_availability(self, movie_title: str) -> dict:
        ...
        if is_subscribed:
            ...
            rental_platform = self.PLATFORMS[1] if platform["id"] != "prime" else self.PLATFORMS[5]
